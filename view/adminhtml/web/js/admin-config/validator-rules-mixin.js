define([
    ...
    return function (target) {
        $.validator.addMethod(
            ...
            function (value) {
                return utils.isEmptyNoTrim(value) || /^pk_(test_)?[\da-f]{8}\-[\da-f]{4}\-[\da-f]{4}\-[\da-f]{4}\-[\da-f]{12}$/.test(value);
            },
        ...
        $.validator.addMethod(
            ...
            function (value) {
                return utils.isEmptyNoTrim(value) || /^sk_(test_)?[\da-f]{8}\-[\da-f]{4}\-[\da-f]{4}\-[\da-f]{4}\-[\da-f]{12}$/.test(value);
            },
